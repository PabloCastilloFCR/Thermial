...
class SolarLoop:
    ...
    def stop(self):
        self.potencia_bomba1(0)
        self.potencia_calentador(0)

    def potencia_bomba1(self, value):
    ...
    def append_to_data_log(self, timestamp):
        ...
        data = {
            ...
            'Timestamp': timestamp,
            'Bomba1_Potencia_%': self.bomba.potencia,
            'Bomba1_Flujo_L/min': round(self.bomba.flujo, 2),
...
class ProcessLoop:
    ...
    def stop(self):
        self.potencia_bomba2(0)
        self.potencia_dissipador(0)

    def potencia_bomba2(self, value):
        self.bomba.set_potencia(value)
    ...
    def append_to_data_log(self, timestamp):
        self.bomba.get_flujo()  # Damit du auch die Pumpe im ProcessLoop abfragst
        time.sleep(0.1)
        ...
        data = {
            ...
            'Hora': now.strftime('%H:%M:%S'),
            'Timestamp': timestamp,
            'Bomba2_Potencia_%': self.bomba.potencia,
            'Bomba2_Flujo_L/min': round(self.bomba.flujo, 2),
